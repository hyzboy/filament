...
using KtxBundle = image::KtxBundle;
...
namespace Ktx1Reader {
     ...
     */
    Texture* createTexture(Engine* engine, const KtxBundle& ktx, bool srgb,
     ...
     * @param srgb Forces the KTX-specified format into an SRGB format if possible
     */
    Texture* createTexture(Engine* engine, KtxBundle* ktx, bool srgb);
